...
public interface OrdenInterfaz {
	...
	/**
	 * Método que realiza la compra de los carritos del usuario pasado por
	 * parámetros
	 * 
	...
	/**
	 * Método que obtiene todas las compras de un usuario y las devuelve en una
	 * lista de objetos OrdenDTO
	 * 
	 * @param emailUsuario Email del usuario
